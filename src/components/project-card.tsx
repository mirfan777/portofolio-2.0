...
export function ProjectCard({
  ...
  return (
    <Card
      className={
        "flex sm:flex-row flex-col overflow-hidden border hover:shadow-lg transition-all duration-300 ease-out h-full"
      }
    >
      {/* Left side - Image */}
        ...
        <CardHeader className="px-4 py-3">
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <time className="font-sans text-xs">{dates || (year ? `${year}` : "")}</time>
            </div>
